...
export const KO_SCHEDULE: Record<number, { kickoff: string; sede: string }> = {
  ...
  79: { kickoff: "2026-07-01T01:00:00Z", sede: "Ciudad de México (Azteca)" },
  80: { kickoff: "2026-07-01T16:00:00Z", sede: "Atlanta (Mercedes-Benz)" },
  81: { kickoff: "2026-07-02T00:00:00Z", sede: "Santa Clara (Levi's)" },
  ...
  90: { kickoff: "2026-07-04T17:00:00Z", sede: "Houston (NRG)" },
  91: { kickoff: "2026-07-05T20:00:00Z", sede: "East Rutherford (MetLife)" },
  92: { kickoff: "2026-07-06T00:00:00Z", sede: "Ciudad de México (Azteca)" },
  93: { kickoff: "2026-07-06T19:00:00Z", sede: "Arlington (AT&T)" },
